    ...
    <div>
      <div className="flex justify-between items-center max-w-[1200px] mx-auto p-4 montserrat_font font-bold text-xs absolute left-0 right-0 mt-8">
        ...
        <div className="lg:flex lg:gap-12 lg:items-center hidden">
          <div className="flex gap-6 items-center">
            <a href="#">
              <svg
                ...
                height="16"
                fill="#ffffffcc"
                className="bi bi-youtube hover:fill-[#fff]"
                viewBox="0 0 16 16"
              >
            ...
            <a href="#">
              <svg
                ...
                height="16"
                fill="#ffffffcc"
                className="bi bi-instagram hover:fill-[#fff]"
                viewBox="0 0 16 16"
              >
            ...
            <a href="#">
              <svg
                ...
                height="16"
                fill="#ffffffcc"
                className="bi bi-facebook hover:fill-[#fff]"
                viewBox="0 0 16 16"
              >
          ...
          <div>
            <button className="border tracking-[0.15em] border-white px-8 py-3 text-white hover:bg-white hover:text-black">
              LET'S TALK
            </button>
          </div>
        </div>
