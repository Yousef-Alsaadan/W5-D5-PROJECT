    ...
    <div>
      <div className="bg-[#F5F5F5] pt-20 pb-8">
        <div className="flex flex-col gap-16 max-w-[1200px] mx-auto p-4 montserrat_font font-normal text-sm">
            ...
            <div className="flex gap-8 items-center">
              <a href="#">
                <svg
                  ...
                  height="16"
                  fill="#be7c68"
                  className="bi bi-youtube hover:fill-[#000]"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="#">
                <svg
                  ...
                  height="16"
                  fill="#be7c68"
                  className="bi bi-instagram hover:fill-[#000]"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="#">
                <svg
                  ...
                  height="16"
                  fill="#be7c68"
                  className="bi bi-facebook hover:fill-[#000]"
                  viewBox="0 0 16 16"
                >
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between items-center text-[#707c84]">
